...
parser.add_argument('--data_dir',default='/home/wx/code/databases/Market-1501/pytorch',type=str, help='training dir path')
parser.add_argument('--train_all', action='store_true', help='use all training data' )
parser.add_argument('--color_jitter', action='store_true', help='use colour jitter in training' )
...
transform_train_list = [
        ...
        transforms.ToTensor(),
        # normalize_iamge = (image-mean)/std
...
dataloaders = {x: torch.utils.data.DataLoader(image_datasets[x],batch_size=opt.batchsize,shuffle=True,num_workers=8)
                  for x in ['train', 'val']}
...
def train_model(model, criterion, optimizer, scheduler, num_epochs=25):
    ...
    for epoch in range(num_epochs):
        ...
        print('This epoch time is:{:.0f}m {:.0f}s'.format(
